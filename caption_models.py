...
class CaptionNet(nn.Module):
    ...
    def forward(self, image_vectors, captions_ix):
        ...
        rnn_output, (hidden, cell) = self.rnn(captions_emb, (
        initial_cell.unsqueeze(0), initial_hid.unsqueeze(0)))  # shape: [batch, caption_length, lstm_units]
...
class PseudoInception(Inception3):
